...
\newcommand{\tbg}{Maintenance person\xspace}
\newcommand{\tbgs}{Maintenance people\xspace}
\begin{document}
...
\item Gamified experience? Do we ``reward'' the user for reporting faults or shall we instead offer detailed reports so the IT department can reward users as they want? (Credit's ETCS reward is possible, in the same way as languagges)
